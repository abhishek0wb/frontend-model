...
function App() {
  ...
  const [val, setVal] = useState("Upload file to predict");
  ...
  return (
    <>
      <h1 className=" mt-[5rem] mb-4 text-3xl font-extrabold dark:text-indigo-800 md:text-5xl lg:text-6xl">
        ...
        <br /> for measuring Emotional Intelligence 
      </h1>
      <p className="text-lg font-normal text-green lg:text-xl">
        Upload the CSV file to measure.
      </p>
